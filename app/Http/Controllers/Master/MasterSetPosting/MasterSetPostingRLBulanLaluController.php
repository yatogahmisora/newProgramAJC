...
class MasterSetPostingRLBulanLaluController extends Controller
{
  ...
  public function index(Request $req) {
    ...
    return view('master/masterSetPosting/mastersetpostingrlbulanlalu' , [
      "menul0" => $menul0,
      "periode" => $periode,
      "listData" => $listData
    ]);
  ...
  public function loadAll () {
    $listData = DB::connection('SML')->select("SELECT a.Perkiraan, b.keterangan from dbposthutpiut a
                       left outer join dbperkiraan b on b.perkiraan=a.perkiraan
                       where a.Kode='RLB' order by a.Perkiraan");
    return $listData;
  }
  ...
  public function spAdd(Request $req)
  {
      ...
      // }
      $listData = DB::connection('SML')->update("INSERT INTO DBPOSTHUTPIUT (Perkiraan, Kode, Tipe, Persen, IsBeliJual, IsLokalorExim, IsUM, Akumulasi, Biaya1, Biaya2, PersenBiaya1, PersenBiaya2) VALUES (:kode,  'RLB', 'L', 0, 0, 0, 0, '', '', '', 0, 0)", ['kode' => $req->kode]);
  ...
  {
      $listData = DB::connection('SML')->update("UPDATE DBPOSTHUTPIUT SET Perkiraan = :kode where Perkiraan = :kodeLama and Kode = 'RLB' ", ['kode' => $req->kode, 'kodeLama' => $req->kodeLama]);
