...
class MasterSetPostingBankController extends Controller
{
  ...
  public function index(Request $req) {
    ...
    return view('master/masterSetPosting/mastersetpostingbank' , [
      "menul0" => $menul0,
      "periode" => $periode,
      // "users"=> $users,
      "listData" => $listData
  ...
  public function spAdd(Request $req)
  {
      ...
      $listData = DB::connection('SML')->update('INSERT INTO DBPOSTHUTPIUT (Perkiraan, Kode, Tipe, Persen, IsBeliJual, IsLokalorExim, IsUM, Akumulasi, Biaya1, Biaya2, PersenBiaya1, PersenBiaya2) VALUES (:kode,  \'BANK\', \'L\', 0, 0, 0, 0, \'\', \'\', \'\', 0, 0)', ['kode' => $req->kode]);
  ...
  {
      $listData = DB::connection('SML')->update("UPDATE DBPOSTHUTPIUT SET Perkiraan = :kode where Perkiraan = :kodeLama and Kode = 'BANK' ", ['kode' => $req->kode, 'kodeLama' => $req->kodeLama]);
