...
class MasterSetPostingHutangController extends Controller
{
  ...
  public function index(Request $req) {
    ...
    return view('master/masterSetPosting/mastersetpostinghutang' , [
      "menul0" => $menul0,
      "periode" => $periode,
      // "users"=> $users,
      "listData" => $listData
  ...
  public function spAdd(Request $req)
  {
      ...
      $listData = DB::connection('SML')->update('INSERT INTO DBPOSTHUTPIUT (Perkiraan, Kode, IsLokalorExim, IsUM) VALUES (:kode,  \'HT\', :nama, :uangMuka)', ['kode' => $req->kode, 'nama' => $req->nama, 'uangMuka' => $req->uangMuka]);
  ...
  {
      $listData = DB::connection('SML')->update("UPDATE DBPOSTHUTPIUT SET Perkiraan = :kode, IsLokalorExim = :nama, IsUM = :uangMuka where Perkiraan = :kodeLama and Kode = 'HT' ", 
