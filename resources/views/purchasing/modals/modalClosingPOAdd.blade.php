...
<div class="modal fade" id="modalCloseHeader" tabindex="-1" aria-labelledby="modalCloseHeaderLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="modalCloseHeaderLabel">Close PO Nomor Bukti</h4>
      </div>
      <div class="modal-body">
        <div class="container-fluid mt-4">
          <div class="row">
            <div class="col-12" style="overflow:auto; margin-top:-30px;">
              <h5>Keterangan Batal</h5>
              <textarea type="text" style="width: 100%; resize: none" rows="4" class="form-control" id="input_add_keteranganbatal"></textarea>
            </div>
          </div>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger btn-lg" 
                style="height: 30px; padding: 4px 12px; border-radius: 20px; font-size: 0.75rem; font-weight: 600; text-transform: uppercase; transition: background-color 0.3s, box-shadow 0.3s; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);"
                onclick="buttonCloseModal()">Batal
        </button>
        <button type="button" class="btn btn-primary btn-lg" 
                style="height: 30px; padding: 4px 12px; border-radius: 20px; font-size: 0.75rem; font-weight: 600; text-transform: uppercase; transition: background-color 0.3s, box-shadow 0.3s; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);"
                onclick="submitCloseHeader()">Submit
        </button>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="modalCloseBarang" tabindex="-1" aria-labelledby="modalCloseHeaderLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="modalCloseBarangLabel">Close Barang </h4>
      </div>
      <div class="modal-body">
        <div class="container-fluid mt-4">
          <div class="row">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary btn-lg" 
                style="height: 30px; padding: 4px 12px; border-radius: 20px; font-size: 0.75rem; font-weight: 600; text-transform: uppercase; transition: background-color 0.3s, box-shadow 0.3s; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);"
                onclick="submitCloseBarang()">Submit
        </button>
      </div>
    </div>
  </div>
