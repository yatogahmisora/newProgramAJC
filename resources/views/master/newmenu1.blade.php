...
@section('buttons')
  ...
  <li class="nav-item">
    <a class="btn" style="background-color: yellow; height: 25px; margin-top: 2px; margin-right: 3px;" href="#!" role="button"><i class="fas fa-plus-circle"></i></a>
  </li>
  <li class="nav-item">
...
@section('js')
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      $("#tabel").DataTable({ "lengthChange": false, "paging": false , "ordering" : false});
    });
      ...
      function(){
        ...
        $.ajax({
          ...
          success: function(res) {
            ...
            window.location.href = "tablemenu";
          }
        })
    ...
    function tesclick(tesprint, tesprint1) {
      ...
      $("#tr"+tesprint).css('background-color', '#8B8000');
