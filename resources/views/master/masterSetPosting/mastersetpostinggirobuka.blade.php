...
function loadAll () {
  ...
  document.getElementById('judulPosting').innerHTML = 'Master Posting Giro Buka'
  ...
  dataRefresh.forEach((item, i) => {
    ...
    rowTable += `<tr>
    <td class="text-center">
      <button class="btn btn-success btn-sm hover-tooltip" data-tooltip='Edit Posting Giro Buka'type="button" onclick="buttonEdit('${item.Perkiraan}')"><i class="bi bi-pen"></i></button>
      <button class="btn btn-danger btn-sm hover-tooltip" data-tooltip='Delete Posting Giro Buka'type="button" onclick="buttonDelete('${item.Perkiraan}')"><i class="bi bi-trash"></i></button>
    </td>
...
function buttonDelete (kode) {
  ...
  alertify.confirm('Hapus Perkiraan', 'Apakah yakin ingin menghapus Perkiraan Posting Giro Buka ' + kode + ' ?',
      function() {
        console.log('yes')
...
function submitEdit () {
  ...
  $.ajax({
    url: "{!! url('mastersetpostinggirobukaspedit') !!}",
    type: "post",
    async: false,
    data: {
      _token : _token,
