...
<div class="sp-page-wrap">
  ...
  {{-- <div class="sp-page-head">
    ...
    <button class="btn btn-action-primary" onclick="buttonAdd()">+ Add Posting PPH Keluaran</button>
  </div> --}}
...
function loadAll () {
  ...
  document.getElementById('breadcrumb').innerHTML = "Master Posting PPH Keluaran";
