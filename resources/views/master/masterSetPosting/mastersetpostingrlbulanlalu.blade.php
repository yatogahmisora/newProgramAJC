...
<div class="sp-page-wrap">
  ...
  {{-- <div class="sp-page-head">
    ...
    <button class="btn btn-action-primary" onclick="buttonAdd()">+ Add Posting RL Bulan Lalu</button>
  </div> --}}
...
function loadAll () {
  ...
  document.getElementById('breadcrumb').innerHTML = "Master Posting RL Bulan Lalu";
