...
<div class="sp-page-wrap">
  ...
  {{-- <div class="sp-page-head">
    <div>
      <h1>Master Posting UM Hutang</h1>
    </div>
    <button class="btn btn-action-primary" onclick="buttonAdd()">+ Add Posting UM Hutang</button>
  </div> --}}
...
function loadAll () {
  ...
  document.getElementById('breadcrumb').innerHTML = "Master Posting UM Hutang";
