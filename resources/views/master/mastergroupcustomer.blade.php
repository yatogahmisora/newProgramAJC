...
<div class="row mt-4">
      <div class="col-6 text-left">
        <h2 style="margin-top:-85px;">Master Group Customer</h2>
      </div>
...
function loadAll () {
  ...
  dataRefresh.forEach((item, i) => {
    ...
    <td class="text-center">
      <button class="btn btn-success btn-sm hover-tooltip" type="button" onclick="buttonEdit('${item.KODEGROUPCUSTSUPP}')" data-tooltip='Edit Group Customer'><i class="bi bi-pen"></i></button>
      <button class="btn btn-danger btn-sm hover-tooltip" type="button" onclick="buttonDelete('${item.KODEGROUPCUSTSUPP}')" data-tooltip='Delete Group Customer'><i class="bi bi-trash"></i></button>
    </td>
