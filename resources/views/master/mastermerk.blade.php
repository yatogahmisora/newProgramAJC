...
<div class="row mt-4">
      <div class="col-6 text-left">
        <h2 style="margin-top:-85px;">Master Merk</h2>
      </div>
                        ...
                        <tr >
                          <td class="text-center">
                            <button class="btn btn-success btn-sm" type="button" 
                                    ...
                                    title="Edit Merk" 
                                    onclick="buttonEdit('{{ $listData[$i]->KODEMERK }}')">
                              <i class="bi bi-pen"></i>
                            </button>
                            <button class="btn btn-danger btn-sm" type="button" 
                                    ...
                                    data-bs-placement="top" 
                                    title="Delete Merk" 
                                    onclick="buttonDelete('{{ $listData[$i]->KODEMERK }}')">
                              <i class="bi bi-trash"></i>
                            </button>
                          </td>
                          <td>{{ $listData[$i]->KODEMERK }}</td>
                          <td>{{ $listData[$i]->NAMAMERK }}</td>
...
function loadAll () {
  ...
  dataRefresh.forEach((item, i) => {
    ...
    rowTable += `<tr>
    <td class="text-center">
      <button class="btn btn-success btn-sm hover-tooltip" data-tooltip="Edit Merk" type="button" onclick="buttonEdit('${item.KODEMERK}')"><i class="bi bi-pen"></i></button>
      <button class="btn btn-danger btn-sm hover-tooltip" data-tooltip="Delete Merk" type="button" onclick="buttonDelete('${item.KODEMERK}')"><i class="bi bi-trash"></i></button>
    </td>
    <td>${item.KODEMERK}</td>
    <td>${item.NAMAMERK}</td>
