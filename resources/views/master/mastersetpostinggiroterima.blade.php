...
function loadAll () {
  ...
  $.ajax({
    url: "{!! url('mastersetpostinggiroterimaloadall') !!}",
    type: "get",
    async: false,
    data: {
      _token : _token,
...
function buttonEdit (kode) {
  ...
  let _token = $("#_token").val();
  $.ajax({
    url: "{!! url('mastersetpostinggiroterimaspdetail') !!}",
    type: "get",
    async: false,
    data: {
      _token : _token,
...
function buttonDelete (kode) {
  ...
  alertify.confirm('Hapus Devisi', 'Apakah yakin ingin menghapus Perkiraan Posting Giro Terima ' + kode + ' ?',
      function() {
        console.log('yes')

        $.ajax({
          url: "{!! url('mastersetpostinggiroterimaspdelete') !!}",
          type: "post",
          async: false,
          data: {
            _token : _token,
          ...
          success: function(res) {
            if (res != 1) {
              ...
              console.log(res)
              loadAll()
              alertify.success("Perkiraan Posting Giro Terima telah dihapus");
  ...
  $.ajax({
    ...
    success: function(res) {
      ...
      if (res != 1) {
        ...
        console.log(res ,'!')
        // $("#formEdit").modal('toggle')
        alertify.success("Data Posting Giro Terima telah diedit");
        loadAll()
        $("#formEdit").modal('toggle')
      }
...
function submitAdd () {
  ...
  $.ajax({
    url: "{!! url('mastersetpostinggiroterimaspadd') !!}",
    type: "post",
    async: false,
    data: {
      _token : _token,
    ...
    success: function(res) {
      ...
      if (res != 1) {
        ...
        console.log(res ,'!')
        // $("#formEdit").modal('toggle')
        alertify.success("Data Posting Giro Terima telah ditambah");
        loadAll()
        $("#form").modal('hide')
      }
...
function loadSelectPerkiraan() {
  ...
  $.ajax({
    url: "{!! url('mastersetpostinggiroterimaloadperkiraan') !!}",
    type: "get",
    async: false,
    data: {
      _token: _token,
