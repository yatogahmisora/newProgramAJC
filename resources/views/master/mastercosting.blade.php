...
<div class="row mt-4">
      <div class="col-6 text-left">
        <h2 style="margin-top:-85px;">Master Costing</h2>
      </div>
...
function loadAll () {
  ...
  dataRefresh.forEach((item, i) => {
    ...
    <td class="text-center">
      <button class="btn btn-warning btn-sm hover-tooltip" data-tooltip='Sub-Costing' type="button" onclick="buttonSubCost('${item.KodeCost}')"><i class="bi bi-layout-text-sidebar-reverse"></i></button>
      <button class="btn btn-success btn-sm hover-tooltip" data-tooltip='Edit Costing' type="button" onclick="buttonEdit('${item.KodeCost}')"><i class="bi bi-pen"></i></button>
      <button class="btn btn-danger btn-sm hover-tooltip" data-tooltip='Delete Costing' type="button" onclick="buttonDelete('${item.KodeCost}')"><i class="bi bi-trash"></i></button>
    </td>
    <td>${item.KodeCost}</td>
    <td>${item.NamaCost}</td>
    </tr>`
