...
<link rel="stylesheet" href="{{ asset('css/tableMaster2.css') }}">
  ...
  <div class="sp-page-head">
    ...
    <button class="btn btn-primary" onclick="buttonAdd()">+ Add Jenis Customer</button>
  </div>
  ...
  dataRefresh.forEach((item, i) => {
    ...
    <td style="white-space:nowrap;" class='text-center'>
      <div class="action-buttons-wrap">
          <button data-toggle="tooltip" data-placement="top" title="Menu" class="btn-action-sm btn-action-success" type="button" onclick="buttonEdit('${item.KodeJenis}')"><i class="bi bi-pen"></i></button>
          <button data-toggle="tooltip" data-placement="top" title="Menu" class="btn-action-sm btn-action-danger" type="button" onclick="buttonDelete('${item.KodeJenis}')"><i class="bi bi-trash"></i></button>
      </div>
    </td>
